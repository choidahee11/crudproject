...
public class DeptService {
	...
	public static List<DeptDTO> selectAll() {
	...
	public static void update(DeptDTO dept) {
	...
	public static void insert(DeptDTO newDept) {
		// TODO Auto-generated method stub
		
	}

	public static List<DeptDTO> selectById(String deptId) {
		// TODO Auto-generated method stub
		return null;
	}
